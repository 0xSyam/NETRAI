...
class ParticipantInfoWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
        color: Colors.black
            .withOpacity(0.3), // Mengubah withValues menjadi withOpacity
...
// Widget khusus untuk indikator koneksi di pojok kiri bawah
class ConnectionQualityIndicator extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // Tidak menampilkan apa-apa jika kualitas koneksi tidak diketahui
    if (connectionQuality == ConnectionQuality.unknown) {
      return const SizedBox.shrink();
    }

    // Tentukan ikon dan warna berdasarkan kualitas koneksi
    IconData icon = connectionQuality == ConnectionQuality.poor
        ? Icons.wifi_off_outlined
        : Icons.wifi;
